...
.controller('BookGrpAppntController',function mySuccess($scope,$http){
				console.log('Entered BookGrpAppntController');
})

.controller('ViewPatientsController', function mySuccess($scope, $http){
...
.controller('ViewAdminController',function mySuccess($scope, $http){
...
.controller('ViewDoctorsController', function mySuccess($scope, $http){
